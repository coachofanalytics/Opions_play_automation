...
from gotomeetings import getmeetingresponse, save_meeting_data
...
def goto_meetings_data(startDate, endDate):
	try:
		save_meeting_data(startDate, endDate)
	except Exception as err:
		print(err)
...
if __name__ == '__main__':
	...
	goto_meetings_data(yesterday_date, yesterday_date)
	# send_email()
